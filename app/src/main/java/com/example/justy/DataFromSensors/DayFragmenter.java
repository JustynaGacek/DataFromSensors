...
public class DayFragmenter extends Fragment {

    public DayFragmenter() {
    ...
    public void drawChart(String columnName, LineChart chart){
        ...
        try {
            ...
            parseJSON.getDataFromJSON(GlobalVariables.postRequestPerDay.getResponseArray(), columnName);
